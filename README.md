...
对技术有持续的好奇心，习惯从最底层拆解问题——从 Mach-O 到 SPIR-V，从 Lua VM 到网络协议，喜欢把"黑盒"变成"说明书"。

**🔬 兴趣方向**
- 二进制逆向 / 恶意样本与安全研究
- 游戏引擎架构与渲染管线（Metal / Vulkan / OpenGL）
- 通信协议还原（WebSocket / protobuf / 私有 RPC）
- 自动化工具链开发（Python / Frida / LLVM）

**🛠 技术栈**
Frida · Ghidra · IDA · SPIR-V/LLVM · Python · C++ · Lua · JavaScript · Shell
macOS · Android · Linux
